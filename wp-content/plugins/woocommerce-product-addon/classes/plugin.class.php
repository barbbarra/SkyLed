...
class NM_PersonalizedProduct {
	...
	function __construct() {
	    ...
	    add_filter( 'woocommerce_show_variation_price', 'ppom_hide_variation_rpice_html', 99, 3);
		...
		*/
		...
		/** ============ LOCAL Hooks ==================== */
		 ...
		 add_filter('ppom_meta_data', 'ppom_hooks_register_wpml');
	...
	function wpp_textdomain() {
		$locale_dir = basename( dirname( __FILE__ ) ) . '/languages/';
