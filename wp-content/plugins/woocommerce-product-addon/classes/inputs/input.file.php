...
class NM_File_wooproduct extends PPOM_Inputs{
	...
	private function get_settings(){
		...
		return array (
				...
				/*'popup_width' => array (
						'type' => 'text',
						'title' => __ ( 'Popup width', "ppom" ),
						'desc' => __ ( '(if image) Popup window width in px e.g: 750', "ppom" )
				),
				
				'popup_height' => array (
						'type' => 'text',
						'title' => __ ( 'Popup height', "ppom" ),
						'desc' => __ ( '(if image) Popup window height in px e.g: 550', "ppom" )
				),*/
